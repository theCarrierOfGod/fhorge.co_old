...
export default  function Earn(){
    ...
    const hobbies=hobby
    return(
        <div className={`${((mode.myMode === 'dark') ? "darkNav" : "lightNav")}`} style={{marginTop:"-100px", paddingTop:"100px"}}>
       <Header/>
        <Cards/>
       <Empower/>
       <Empower2/>
       <Empower/>
       <Goal Hobbbies={hobbies} mode={mode}/>
       <Lastpart />
       </div>
    )
}
...
function Header(){
   ...
   return( <div className="Container" >
    ...
    <h1 className='head'> Earn Money By <br></br>Empowering Millions</h1></header>
</div>
)
}
function Empower(){
